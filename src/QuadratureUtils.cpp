	...
	void QuadratureUtils::SetQuadratureRule(unsigned const &Npe)
	{
		switch (Npe)
		{
			...
			case 8:
			{
				...
				_QuadPoint(3,0) =   q;   _QuadPoint(3,1) = 0.0;
				_QuadPoint(4,0) = 0.0;   _QuadPoint(4,1) = 0.0;
				_QuadPoint(5,0) = 0.0;   _QuadPoint(5,1) =   q;
				_QuadPoint(6,0) =   q;   _QuadPoint(6,1) =   q;
				_QuadPoint(7,0) =  -q;   _QuadPoint(7,1) = 0.0;
				_QuadPoint(8,0) =  -q;   _QuadPoint(8,1) =   q;
				break;
			}
